...
animals = {1: [('Серое животное с хоботом?', 'Слон'), ('Коричневый мохнатый зверь, который любит мёд?', 'Медведь')],
             ...
             3: [('Млекопитающее, являющееся самым большим животным из всех?', 'Синий кит'), ('ночной хищник, который имеет возможность выживать без воды в пустыне и относится к псовым?', 'Фенек')]}
